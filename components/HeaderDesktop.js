            ...
            <React.Fragment>
                ...
                >
                    <Sticky context={this.props.contextRef}>
                        <Segment inverted vertical style={{ minHeight: 100 , padding: '1em 0em 0em 0em', textAlign: 'flex-end'}}>
                            <Menu inverted stackable fixed='top' size='large'>
                                <Container>
                                    <Link route="/">
                                        <a className = "item">
                                            Home
                                ...
                                <Container style={{marginTop: '40px'}}>
                                    <Grid inverted style={{padding: '0em 1em'}} relaxed verticalAlign='bottom'>
                                        ...
                                        <Grid.Column width={7} textAlign='center'>
                                            <Input icon={<Icon name='search' inverted circular link />} placeholder='Search...' size='small' fluid/>
                                        </Grid.Column>
